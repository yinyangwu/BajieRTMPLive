...
public class UVCCameraHandler extends AbstractUVCCameraHandler {
     ...
     * @return
     */
    public static UVCCameraHandler createHandler(Activity parent, CameraViewInterface cameraView, int width, int height) {
     ...
     * @return
     */
    public static UVCCameraHandler createHandler(Activity parent, CameraViewInterface cameraView,
    ...
    public static UVCCameraHandler createHandler(Activity parent, CameraViewInterface cameraView,
        ...
        CameraThread thread = new CameraThread(UVCCameraHandler.class, parent, cameraView, encoderType, width, height, format, bandwidthFactor);
        thread.start();
        return (UVCCameraHandler) thread.getHandler();
    }

    protected UVCCameraHandler(CameraThread thread) {
        super(thread);
    }
